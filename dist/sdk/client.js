...
export class BaseExtractorClient {
    ...
    async extract(targetUrl) {
        ...
        if (res.status === 402 && this.privateKey) {
            ...
            const recipient = paymentSpec.recipient;
            const tokenAddress = (paymentSpec.token || '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913');
    ...
    async deposit(amountUsdc) {
        ...
        const recipient = '0x2231b680679FC790B5E676b0d566EF2EE4612414';
