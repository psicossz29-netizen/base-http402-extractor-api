...
export const CONFIG = {
  ...
  PUBLIC_URL: process.env.PUBLIC_URL || 'https://base-http402-extractor-api.resilient-jaguar.workers.dev',
  ...
  AGENT_PRIVATE_KEY: (process.env.AGENT_PRIVATE_KEY || '0xe27926ab68c297b3e2d48c87a668b4ec694b1491d68db84044a45cb334ddb172') as `0x${string}`,
  AGENT_PUBLIC_ADDRESS: (process.env.AGENT_PUBLIC_ADDRESS || '0x2231b680679FC790B5E676b0d566EF2EE4612414') as Address,
